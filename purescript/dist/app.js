...
(function($PS) {
  ...
  var year = Halogen_Component.mkComponent({
      initialState: function (input) {
          return input;
      },
      render: function (year1) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(year1)) ]);
      },
  ...
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "year";
          }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(year)(2020)(Data_Function["const"](Data_Maybe.Nothing.value)) ]);
      };
